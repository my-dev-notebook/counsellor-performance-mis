...
export default async function AgenciesPage() {
  ...
  return (
    <div data-component="AgenciesPage" className="mx-auto w-full max-w-7xl flex-1 space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-zinc-900">Agencies</h1>
