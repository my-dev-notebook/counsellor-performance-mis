...
export default async function CounsellorReportPage({
  ...
  const requestedId =
    typeof params.personId === "string" ? Number.parseInt(params.personId, 10) : NaN;
  ...
  return (
    <div data-component="CounsellorReportPage" className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold tracking-tight text-zinc-900">Counsellor History</h1>
        <p className="mt-1 text-sm text-zinc-500">
          One counsellor&apos;s Target/Achieved/% across every month on record, across every team
